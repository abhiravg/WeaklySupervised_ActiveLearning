...
validation_df = weak_supervisor(pd.DataFrame(unlab_df), "label_model")
...
classifier, Y_test_predicted, Y_val_predicted = train(X_train, Y_train, X_val, X_test)
...
while queried_samples < max_queries:
    ...
    Y_train = vstack([Y_train, Y_new_weak_val])
